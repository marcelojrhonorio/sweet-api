...
class ResearchAnswer extends Model
{
     ...
     */
    protected $fillable = [
        'research_id', 'question_id', 'option_id', 'answer_string',
    ];
    ...
    public function __construct(array $attributes = array())
    {
        ...
        $this->rules = [
            ...
            'option_id'         => 'required|exists:'.env('DB_CONNECTION_INFOPRODUTO', 'infoproduto_mysql').'.research_options,id',
    ...
    {
        return $this->belongsTo('App\Models\Infoproduto\ResearchOption', 'option_id', 'id');
    }        
}
