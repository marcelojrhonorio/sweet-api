...
class ResearchAnswer extends Model
{
    ...
    public function __construct(array $attributes = array())
    {
        ...
        $this->rules = [
            ...
            'option_id'         => 'required|exists:'.env('DB_CONNECTION_GREENPEACE_OCEANOS', 'greenpeace_oceanos_mysql').'.research_options,id',
        ];        
    }
    ...
    {
        return $this->belongsTo('App\Models\GreenpeaceOceanos\ResearchOption', 'option_id', 'id');
    }    
}
